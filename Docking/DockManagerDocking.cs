...
namespace Docking
{
    public partial class DockManagerDocking : XtraForm
    {
        ...
        private void DockManagerDocking_Load(object sender, EventArgs e)
        {
            ...
            LeftDockPanel.Visibility=DockVisibility.AutoHide;
            dockManager1.AutoHiddenPanelShowMode= AutoHiddenPanelShowMode.MouseClick;
            LeftDockPanel.Expanded += LeftDockPanel_Expanded;
            dpBottom.CustomButtonClick += DpBottom_CustomButtonClick;
        }

        private void LeftDockPanel_Expanded(object sender, DevExpress.XtraBars.Docking.DockPanelEventArgs e)
        {
        ...
        {
            $"hideContainerLeft_Click".TraceRecord();
